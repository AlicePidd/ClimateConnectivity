...
> ### Ocean warming and network configuration drive climate connectivity among Australia's marine protected areas
>
...
├── shapefiles          <--- .RDS files of shapefiles used in computation and spatial plotting
